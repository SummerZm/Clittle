...
int main()
{
   ...
   char fullversion[9];
   memset(fullversion, 0, sizeof(fullversion));
   getCharFromHex(charVersion, fullversion, 4, 8);
   printf("fullversion=%s\n",fullversion);
   printf("fullversion=%d-%d-%d-%d\n", fullversion[0], fullversion[1], fullversion[2], fullversion[3]);
   printf("fullversion=%c-%c-%c-%c\n", fullversion[0], fullversion[1], fullversion[2], fullversion[3]);
